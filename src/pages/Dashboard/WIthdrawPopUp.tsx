...
export default function WithdrawPopUp({ asset, isOpen, onClose, marginBalance }: Props) {
  ...
  const fetchUserMarginBalance = async () => {
    try {
      if (readWriteAgent) {
  ...
  const withdrawFromAccount = async (e: React.MouseEvent) => { 
    ...
    try {
      ...
      //     user
      //   );
        // await vaultActor.withdrawfromAccount(amount.toBigInt(), user);
              ...
              <div>
                ...
                <div className="bg-[#18191D] p-3 rounded-lg">
                  ...
                  <div className="text-sm text-gray-400 flex justify-between mt-2">
                    <span className="text-white">Available: <span className="text-xs text-gray-400">{formatBalance(userMarginBalance)} {asset.symbol}</span></span>
              ...
              <div className="mb-6">
                <label className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-500">
                    I agree with the terms and conditions of the platform's withdraw service.
                  </span>
                </label>
              </div>
        ...
        {view === "preview" && (
          <>
            ...
            <div className="text-center pt-5">
              ...
              <p className="text-gray-400">You will withdraw <span className="text-green-600">${dollarValue}</span></p>
